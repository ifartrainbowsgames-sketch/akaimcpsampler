...
- [ ] Repo `singularity lab` (this folder) with monorepo layout
...
- [ ] Single sandbox worker; CLI: `python -m singularity run "fix the login bug"`
...
1. **Scaffold in **singularity lab** (separate from akaimcpsampler).
